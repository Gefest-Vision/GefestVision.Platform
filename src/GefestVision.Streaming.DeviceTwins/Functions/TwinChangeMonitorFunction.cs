...
namespace GefestVision.Streaming.DeviceTwins.Functions;
...
public class TwinChangeMonitorFunction : AzureEventHubsFunction
{
    ...
    public async Task Run(
        [EventHubTrigger("twin-changes", Connection = "EventHubs.ConnectionStrings.TwinChanges")] EventData[] events,
        ILogger logger)
    {
