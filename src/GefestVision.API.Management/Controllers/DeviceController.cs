...
public class DeviceController : ControllerBase
{
    ...
    [SwaggerResponseHeader(new[] { (int)HttpStatusCode.OK, (int)HttpStatusCode.InternalServerError }, "RequestId",
        "string", "The header that has a request ID that uniquely identifies this operation call")]
    [SwaggerResponseHeader(new[] { (int)HttpStatusCode.OK, (int)HttpStatusCode.InternalServerError },
    ...
    [SwaggerResponseHeader(new[] { (int)HttpStatusCode.OK, (int)HttpStatusCode.InternalServerError },
        "X-Transaction-Id", "string",
        "The header that has the transaction ID is used to correlate multiple operation calls.")]
    public async Task<IActionResult> ChangeIpAddress([FromRoute] string deviceId,
        [FromBody] NewIpAddress newIpAddressInfo)
    {
    ...
    [SwaggerResponseHeader(new[] { (int)HttpStatusCode.OK, (int)HttpStatusCode.InternalServerError },
        "X-Transaction-Id", "string",
        "The header that has the transaction ID is used to correlate multiple operation calls.")]
    public async Task<IActionResult> Provision([FromRoute] string deviceId,
        [FromBody] ProvisionedDeviceInfo provisionedDeviceInfo)
    {
