...
public class Startup
{
    ...
    private static void RestrictToJsonContentType(MvcOptions options)
    {
        ...
        foreach (var inputFormatter in allButJsonInputFormatters)
        {
    ...
    private static void AddEnumAsStringRepresentation(MvcOptions options)
    {
        ...
        foreach (var inputFormatter in onlyJsonInputFormatters)
        {
        ...
        foreach (var outputFormatter in onlyJsonOutputFormatters)
        {
